    ...
    <div class="m-portlet">
        <div class="m-portlet__head">
            <div class="m-portlet__head-wrapper">
                ...
                <a href="{{ route('admin-bloodbank-create') }}" class="btn btn-success m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
                    ...
                    <!-- import button-->
                    <a href="{{ route('admin-bloodbank-import') }}" class="btn btn-primary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
                            <i class="fa fa-upload"></i>
                            <span>Import</span>
                        </span>
                    </a>
                    <a href="{{ route('admin-bloodbank-export') }}" class="btn btn-primary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
                            <i class="fa fa-upload"></i>
                            <span>Export</span>
                        </span>
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                ...
                <!-- Search Bar -->
                <form action="{{ route('admin-bloodbank-show') }}" method="GET">
                            ...
                            @foreach ($bloodBankInfo as $requests)
                                <tr class="dd">
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <form method="POST" action="{{ route('admin-bloodbank-delete', ['id' => $requests->bloodBankInfoId]) }}">
                                            @csrf
                                            @method('DELETE')
