    ...
    <div class="m-portlet">
        <div class="m-portlet__head">
            <div class="m-portlet__head-wrapper">
                ...
                <a href="{{route('event-addEvent')}}" class="btn btn-success m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
                            ...
                            @php $serial = 1; @endphp <!-- Initialize serial number counter -->
                                ...
                                <tr class="dd">
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <form method="POST" action="{{ route('event-delete', ['id' => $event->eventId]) }}">
                                            @csrf
                                            @method('DELETE')
