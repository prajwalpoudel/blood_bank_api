    ...
    <div class="m-portlet">
        ...
        <div class="m-portlet__body">
            <div class="m-section">
                ...
                <!-- Search Bar -->
                <form action="{{ route('emergency-request-show') }}" method="GET">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="emergencyRequestTable">
                        <thead>
                            <tr class="table-primary">
                               ...
                               <tbody>
                                @foreach ($emergencyRequestBlood as $requests)
                                <tr class="dd">
                                    <td>{{ $requests->emergencyRequestId }}</td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <form method="POST" action="{{ route('emergency-request-delete', ['id' => $requests->emergencyRequestId]) }}">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="12">
                                        ...
                                        <div class="pagination justify-content-center">
                                            {{ $emergencyRequestBlood->onEachSide(3)->links() }}
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
